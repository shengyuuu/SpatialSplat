...
from .lseg_extract import LSegArgs
...
class Net(LSegNet):
    ...
    def from_pretrained(cls, device, *args, **kwargs):
        ...
        ckpt = torch.load(LSegArgs.pretrained_model_name_or_path, map_location='cpu', weights_only=False)
