...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                (num_rendered, 
                 ...
                 geomBuffer, 
                 binningBuffer, 
                 imgBuffer) = _C.rasterize_gaussians(*args)
        ...
        ctx.save_for_backward(colors_precomp, 
                              ...
                              binningBuffer, 
                              imgBuffer)
        return color, language_feature, instance_feature, radii

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_language_feature, grad_out_instance_feature, _):
...
class GaussianRasterizationSettings(NamedTuple):
    ...
    include_instance_feature: bool = False
